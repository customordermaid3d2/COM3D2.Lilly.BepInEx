...
namespace COM3D2.Lilly.BepInEx
{
    public static class MaidPatch
    {
        ...
        [HarmonyPrefix]
        public static void SetPropPrefix1(Maid __instance, MaidProp mp, string filename, int f_nFileNameRID, bool f_bTemp, bool f_bNoScale)
        {
        ...
        [HarmonyPrefix]
        public static void SetPropPrefix2(Maid __instance, MPN idx, int val, bool f_bTemp)
        {
            MyLog.Log("Maid.SetPropPrefix2().strTempFileName:" + __instance.GetProp(idx).strTempFileName);
            MyLog.Log("Maid.SetPropPrefix2().strFileName:" + __instance.GetProp(idx).strFileName);
        }
